...
import { normalizeKosType } from '../shared';
import styles from '../prototype.module.css';
import type { JobItemState } from '@/hooks/useJobPoller';
...
const LLM_PROFILES_STORAGE_KEY = 'prototype_llm_profiles_v1';
const LLM_ACTIVE_PROFILE_STORAGE_KEY = 'prototype_llm_active_profile_v1';
...
function parseStatusFromJobItem(status: JobItemState['status']): ParseStatus {
...
export default function PrototypeCleanDataPage() {
  ...
  const jobs = useJobPoller(jobIds, { interval: 2000, onMissing: handleMissingJob });
